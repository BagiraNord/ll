...
// const handleCreate = () => { // handleCreate (įrankisSukurti)
// const data = {
// type: type,
// color: color,
// isalive: isalive // šalia žodžio įvesto atsiranda raudonas blokelis
// }
// create(data);
// setType('');
// setColor('yellow');
...
// switch(d) { // switch -jungiklis
// case 'type': // case -atvejis
